	...
	return (
		<html lang="en" className="mocha">
			...
			<body className="bg-ctp-base text-ctp-text font-mono min-h-screen w-full selection:bg-ctp-mauve/30 flex flex-col">
				<button
					id="theme-toggle"
					className="fixed top-5 right-5 bg-ctp-mantle border border-ctp-surface0 text-ctp-text w-10 h-10 rounded-full cursor-pointer flex items-center justify-center shadow-lg z-50 hover:bg-ctp-surface0 transition-all hover:scale-110 active:scale-95"
					title="Toggle Theme"
				>
